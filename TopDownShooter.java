			...
			public void handle(ActionEvent event){
				...
				for(int i = 0; i <temp; i++){
					if(mobs.getSwarm(0) instanceof LaserMachine){
						pe.CircleExplosion(mobs.getSwarm(0).getAbsoluteMiddleX(),mobs.getSwarm(0).getAbsoluteMiddleY(),Color.BLACK);
					}
			...
			for(int i = 0; i < mobs.getSwarm().size(); i++){
				...
				if(mobs.getSwarm(i).getHealth() < 0){
					if(mobs.getSwarm(i) instanceof LaserMachine){
						pe.CircleExplosion(mobs.getSwarm(i).getAbsoluteMiddleX(),mobs.getSwarm(i).getAbsoluteMiddleY(),Color.BLACK);
					}
					...
					if(mobs.getSwarm(i) instanceof Bouncer){
						pe.RectExplosion(mobs.getSwarm(i).getAbsoluteMiddleX(),mobs.getSwarm(i).getAbsoluteMiddleY(),Color.PURPLE);
					}
